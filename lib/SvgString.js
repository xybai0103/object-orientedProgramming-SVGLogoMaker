...
createSvgString.prototype.circle = () => {
    const circle = new Circle().render(shapeColor);
    const text = new Text().render(text, textColor);
    return [
...
createSvgString.prototype.square = () => {
    const square = new Square().render(shapeColor);
    const text = new Text().render(text, textColor);
    return [
        '<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">',
        `${square}`,
...
createSvgString.prototype.triangle = () => {
    const triangle = new Triangle().render(shapeColor);
    const text = new Text().render(text, textColor);
    return [
        '<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">',
        `${triangle}`,
